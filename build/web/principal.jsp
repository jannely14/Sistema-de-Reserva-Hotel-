        ...
        <div class="content flex_space">
            ...
            <div class="navhotel">
                <ul id="indicelist">
                    ...
                    <li><a href="Login/IniciaSesion.jsp">Ofertas</a></li>
                    <li><a href="evento.html">Eventos</a></li>
                    <li><a href="#contacto">Contacto</a></li>
                    <i class="fas fa-comments" id="chat-icon" style="cursor: pointer;"></i>
                    <li><a href="Login/IniciaSesion.html"><button class="primary-btn">INICIAR SESION</button></a></li>
                </ul>
            ...
            <div class="owl-carousel owl-theme">
                <div class="item">
                    ...
                    <div class="text">
                        ...
                        <div class="flex">
                            <a href="explora.jsp"><button  class="primary-btn">EXPLORA MAS</button></a>
