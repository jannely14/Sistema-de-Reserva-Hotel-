...
<body>
    ...
    <section class="detalle-habitacion">
        <div class="container flex_space">
            <div class="galeria">
                <h2>Galería</h2>
                <img src="../imagenes/estandar.png" alt="Habitación Clásica">
            </div>
            <div class="info-habitacion">
                <h2>Habitación Estandar</h2>
                <p class="precio">S/ 70.00</p>
                <p class="descripcion-habitacion">
                    Habitación de lujo con vista a la calle hecha para clientes exclusivos que deseen pasar un momento inolvidable junto a su pareja.
                </p>
        ...
        <div class="container">
            ...
            <div class="productos-grid">
                <div class="producto-item">
                    <img src="../imagenes/junior.png" alt="Habitacion Junior">
                    <h3>Habitacion Junior</h3>
                    <h3>Barra bar</h3>
                    <a href="detalle_junior.html" class="btn-leer-mas">Leer más</a>
                </div>
                <div class="producto-item">
